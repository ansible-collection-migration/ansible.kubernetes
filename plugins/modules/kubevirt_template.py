...
- ansible.kubernetes.k8s_auth_options
- ansible.kubernetes.k8s_state_options
'''
...
from ansible_collections.ansible.kubernetes.plugins.module_utils.k8s.common import AUTH_ARG_SPEC

from ansible_collections.ansible.kubernetes.plugins.module_utils.kubevirt import (
    virtdict,
    KubeVirtRawModule,
    API_GROUP,
